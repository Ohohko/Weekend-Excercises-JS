...
const nb_Year = (popstart, percent, aug, population) => {
    let years = 0;
    while (popstart < population) {
        popstart += popstart * (percent / 100) + aug;
        years++;
    }
    return years;
};
...
console.log(nb_Year(11500000,1.15,1000000,200000000)) //94
